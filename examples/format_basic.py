...
# the example below vibe evaluates the result of the add_number function with
# a vibeformat decorator to coerce the return type
...
@vc
@vibeformat(response_type=int)  # optional, enforces the response type to be int
